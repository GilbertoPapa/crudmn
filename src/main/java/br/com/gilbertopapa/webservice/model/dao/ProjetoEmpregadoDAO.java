...
public class ProjetoEmpregadoDAO {
    ...
    public List<Empregado> getEmpregados(long projetoId) {
        ...
        try {
            ...
            throw new DAOException("Erro ao recuperar os empregados do projeto de id " + projetoId +
            " do banco: " + ex.getMessage(),
    ...
    public List<Projeto> getProjetos(long empregadoId) {
        ...
        try {
            ...
            throw new DAOException("Erro ao recuperar os projetos em que o empregado de id " + empregadoId + " está trabalhando: "
